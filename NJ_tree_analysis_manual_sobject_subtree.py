...
tree_folder += 'NJ_clusters_cannon_3.0_abundflags_ucac5_norm_hier_weighted_cityblocknans_loose_ra_254.7_dec_-52.7_rad_7.0/'
# find the following sobject_id in a tree and analyze a subtree that it belongs to
sobject_id = 170830001101126
...
if len(target_node) < 1:
    ...
    node_to_analyze = get_major_split(node_before_object, max_add_objects=8, n_levels=4)
