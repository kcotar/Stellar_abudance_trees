...
tree_folder += 'NJ_tree_cannon_3.0_abundflags_ucac5_norep_norm_hier_weighted_cityblocknans_loose_ra_200.0_dec_-47.0_rad_20.0/'
# find the following sobject_id in a tree and analyze a subtree that it belongs to
sobject_id = 150211004701104
...
if len(target_node) < 1:
    ...
    node_to_analyze = get_major_split(node_before_object, max_add_objects=8, n_levels=13)
